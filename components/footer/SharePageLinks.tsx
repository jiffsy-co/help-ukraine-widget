...
import { JiffsyLinkedInLink, JiffsyTwitterLink, JiffsyFacebookLink } from '../constants'
...
const SharePageLinks = () => (
  <div className="flex flex-col w-7.5 items-center mt-2.5 mb-5 md:mt-0 md:mb-0">
    ...
    <div className="flex justify-between w-7.5">
      <a href={JiffsyFacebookLink} className="opacity-70 hover:opacity-100">
        <FacebookLogo />
      </a>
      <a href={JiffsyTwitterLink} className="opacity-70 hover:opacity-100">
        <TwitterLogo />
      </a>
      <a href={JiffsyLinkedInLink} className="opacity-70 hover:opacity-100">
        <LinkedInLogo />
      </a>
    </div>
  </div>
